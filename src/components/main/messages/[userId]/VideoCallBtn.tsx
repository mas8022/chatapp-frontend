...
export const VideoCallBtn = ({
  ...
  const {
    ...
    toggleMute,
    toggleVideo,
  } = useVideoCall(targetUserId);

  return (
    <>
      {/* دکمه شروع تماس تصویری در هدر چت */}
      <Button
        variant="ghost"
        size="icon"
        onClick={startCall}
      ...
      {/* مدال تماس تصویری - تا زمانی که تماس کاملاً قطع نشود (idle نباشد) باز می‌ماند */}
