...
export default function ContactsListPage() {
  return (
    <main className="relative flex min-h-[100dvh] items-center justify-center overflow-hidden bg-[#030712] p-0 text-white sm:p-4 md:p-6">
      ...
      <section className="relative flex h-[100dvh] w-full max-w-2xl flex-col overflow-hidden border border-white/10 bg-black/45 shadow-2xl shadow-blue-950/50 backdrop-blur-2xl sm:h-[calc(100dvh-3rem)] sm:rounded-3xl">
        <Header />
        <ScrollAreaBody />
      </section>
    </main>
